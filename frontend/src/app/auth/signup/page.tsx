    ...
    return (
        <div className="min-h-screen flex flex-col bg-[#050508] relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className="absolute top-[-20%] right-[-15%] w-[80vw] h-[80vw] bg-emerald-600/8 rounded-full blur-[100px]" />
                <div className="absolute bottom-[-10%] left-[-10%] w-[60vw] h-[60vw] bg-blue-600/8 rounded-full blur-[80px]" />
            </div>
            ...
            <div className="relative z-10 flex-1 flex items-center justify-center px-5 py-16">
                ...
                >
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-gray-500 text-xs mt-1">Join the future of trading intelligence</p>
                    </div>
                    ...
                    <form onSubmit={handleEmailSignup} className="space-y-3">
                        <div>
                            <label className="block text-[10px] uppercase tracking-widest text-gray-500 mb-1.5 ml-1">Nickname</label>
                            <input
                                type="text"
                                required
                        ...
                        <button
                            ...
                            className="w-full py-4 bg-gradient-to-r from-emerald-600 to-blue-600 rounded-2xl font-bold text-sm tracking-widest uppercase hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-1 shadow-[0_0_30px_rgba(16,185,129,0.2)]"
                        >
                    ...
                    <div className="mt-8 flex flex-col items-center gap-3 text-xs text-gray-500">
                        <p>
                            ...
                            <Link href="/auth/login" className="text-blue-400 hover:text-blue-300 font-bold">
                                Sign in
                            </Link>
                        </p>
